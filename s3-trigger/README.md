# S3 Trigger Test Deployment #

This project is used to create the resources used for running a trigger after a file has been added to an S3 bucket. Services used includes:
