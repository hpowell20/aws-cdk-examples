...
This project is used to create the Virtual Private Cloud (VPC) resources.  This allows for services to run in isolation from others within an account. Services used includes:
